#! /bin/sh
set -e
export JAVA_HOME=/mnt/onego/panpan/player/jdk1.8.0_112
export JRE_HOME=/mnt/onego/panpan/player/jdk1.8.0_112/jre
export CLASSPATH=.:$CLASSPATH:$JAVA_HOME/lib:$JAVA_HOME/jre/lib
export PATH=$JAVA_HOME/bin:$JAVA_HOME/jre/bin:$PATH:$HOME/bin

export ANDROID_SDK=/mnt/onego/panpan/player/sdk/adt-bundle-linux-x86-20130917/sdk
export ANDROID_NDK=/mnt/onego/panpan/player/android-ndk-r13b
